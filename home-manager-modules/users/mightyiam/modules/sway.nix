...
mkIf config.gui.enable {
  ...
  wayland.windowManager.sway.config.keybindings.${keyboard.wm.terminal} = "exec ${
  ...
  wayland.windowManager.sway.config.keybindings.${
    keyboard.wm.moveToWorkspace."1"
  } = "move container to workspace number 1";
  wayland.windowManager.sway.config.keybindings.${
    keyboard.wm.moveToWorkspace."2"
  } = "move container to workspace number 2";
  wayland.windowManager.sway.config.keybindings.${
    keyboard.wm.moveToWorkspace."3"
  } = "move container to workspace number 3";
  wayland.windowManager.sway.config.keybindings.${
    keyboard.wm.moveToWorkspace."4"
  } = "move container to workspace number 4";
  wayland.windowManager.sway.config.keybindings.${
    keyboard.wm.moveToWorkspace."5"
  } = "move container to workspace number 5";
  wayland.windowManager.sway.config.keybindings.${
    keyboard.wm.moveToWorkspace."6"
  } = "move container to workspace number 6";
  wayland.windowManager.sway.config.keybindings.${
    keyboard.wm.moveToWorkspace."7"
  } = "move container to workspace number 7";
  wayland.windowManager.sway.config.keybindings.${
    keyboard.wm.moveToWorkspace."8"
  } = "move container to workspace number 8";
  wayland.windowManager.sway.config.keybindings.${
    keyboard.wm.moveToWorkspace."9"
  ...
  wayland.windowManager.sway.config.keybindings.${keyboard.wm.volume.toggleMuteSources} =
    toggleMuteSources;
